...
import 'kingdom_arena_details_model.dart';
export 'kingdom_arena_details_model.dart';

class KingdomArenaDetailsWidget extends StatefulWidget {
  const KingdomArenaDetailsWidget({super.key});

  @override
  State<KingdomArenaDetailsWidget> createState() =>
      _KingdomArenaDetailsWidgetState();
}

class _KingdomArenaDetailsWidgetState extends State<KingdomArenaDetailsWidget>
    with TickerProviderStateMixin {
  late KingdomArenaDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KingdomArenaDetailsModel());
  }
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'With prime facilities and a convenient location, it\'s your ultimate destination for football excitement. Reserve your spot now and experience the thrill of the game at Kingdom Arena!',
