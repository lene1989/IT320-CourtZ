...
import 'basketballhouse_details_model.dart';
export 'basketballhouse_details_model.dart';

class BasketballhouseDetailsWidget extends StatefulWidget {
  const BasketballhouseDetailsWidget({super.key});

  @override
  State<BasketballhouseDetailsWidget> createState() =>
      _BasketballhouseDetailsWidgetState();
}

class _BasketballhouseDetailsWidgetState
    extends State<BasketballhouseDetailsWidget> with TickerProviderStateMixin {
  late BasketballhouseDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BasketballhouseDetailsModel());
  }
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'Your ultimate destination for basketball enthusiasts! Rent our fully equipped basketball court for thrilling games with friends or team practice sessions. Our spacious court, complete with high-quality flooring and lighting, ensures an optimal playing experience. Conveniently located with easy access',
