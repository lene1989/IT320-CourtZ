...
import 'game_o_n_details_model.dart';
export 'game_o_n_details_model.dart';

class GameONDetailsWidget extends StatefulWidget {
  const GameONDetailsWidget({super.key});

  @override
  State<GameONDetailsWidget> createState() => _GameONDetailsWidgetState();
}

class _GameONDetailsWidgetState extends State<GameONDetailsWidget>
    with TickerProviderStateMixin {
  late GameONDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameONDetailsModel());
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'Your court, your game! Step onto our courts and experience the thrill of tennis like never before. With pristine surfaces and a lively atmosphere, it\'s where champions play. Book your court now and get your game ON at Game ON Tennis Court!',
                        ...
                        var confirmDialogResponse = await showDialog<bool>(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: const Text('Are you syre?'),
                                  actions: [
                                    TextButton(
