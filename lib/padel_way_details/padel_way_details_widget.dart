...
import 'padel_way_details_model.dart';
export 'padel_way_details_model.dart';

class PadelWayDetailsWidget extends StatefulWidget {
  const PadelWayDetailsWidget({super.key});

  @override
  State<PadelWayDetailsWidget> createState() => _PadelWayDetailsWidgetState();
}

class _PadelWayDetailsWidgetState extends State<PadelWayDetailsWidget>
    with TickerProviderStateMixin {
  late PadelWayDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PadelWayDetailsModel());
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            alignment: const AlignmentDirectional(0.96, 0.65),
                            child: Text(
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'Padelway, where every swing counts and every rally shines. Our cutting-edge padel courts redefine the game, offering a thrilling experience for players of all skill levels. With expertly crafted facilities and a welcoming atmosphere, Padelway is your ultimate destination for the perfect match. Join us and let your padel journey unfold in style',
