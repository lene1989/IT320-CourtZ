...
import 'the_palm_court_details_model.dart';
export 'the_palm_court_details_model.dart';

class ThePalmCourtDetailsWidget extends StatefulWidget {
  const ThePalmCourtDetailsWidget({super.key});

  @override
  State<ThePalmCourtDetailsWidget> createState() =>
      _ThePalmCourtDetailsWidgetState();
}

class _ThePalmCourtDetailsWidgetState extends State<ThePalmCourtDetailsWidget>
    with TickerProviderStateMixin {
  late ThePalmCourtDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThePalmCourtDetailsModel());
  }
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'Enjoy thrilling basketball games or practice sessions on our top-quality court. Conveniently located with great amenities, it\'s the perfect spot for basketball enthusiasts. Book your game now and experience the excitement at The Palm Court!',
