...
import 'basketball_champ_details_model.dart';
export 'basketball_champ_details_model.dart';

class BasketballChampDetailsWidget extends StatefulWidget {
  const BasketballChampDetailsWidget({super.key});

  @override
  State<BasketballChampDetailsWidget> createState() =>
      _BasketballChampDetailsWidgetState();
}

class _BasketballChampDetailsWidgetState
    extends State<BasketballChampDetailsWidget> with TickerProviderStateMixin {
  late BasketballChampDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BasketballChampDetailsModel());
  }
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'Where champions are made! Our court is your arena for intense matches and skill-building sessions. With premium facilities and a vibrant atmosphere, it\'s the ultimate destination for basketball enthusiasts. Join us on the court and unleash your inner champ at Basketball Champ!',
