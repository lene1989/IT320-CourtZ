...
import 'a_c_t_i_v_e_details_model.dart';
export 'a_c_t_i_v_e_details_model.dart';

class ACTIVEDetailsWidget extends StatefulWidget {
  const ACTIVEDetailsWidget({super.key});

  @override
  State<ACTIVEDetailsWidget> createState() => _ACTIVEDetailsWidgetState();
}

class _ACTIVEDetailsWidgetState extends State<ACTIVEDetailsWidget>
    with TickerProviderStateMixin {
  late ACTIVEDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ACTIVEDetailsModel());
  }
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'Where your game comes to life! Experience the thrill of tennis on our top-notch court. With premium surfaces and modern facilities, it\'s the perfect spot for active players. Book your court now and get ready to serve up some fun at ACTIVE Tennis Court!',
